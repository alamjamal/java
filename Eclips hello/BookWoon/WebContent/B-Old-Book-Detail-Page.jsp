...
.old-book-info tr, .old-book-info td {
	text-align: left;
	border-collapse: collapse;
	padding: 6px;
}
	...
	<div class="middle">
		...
		<div class="old-book-info">
			<%
				...
				List<OldBookPOJO> list = dao.getOldBookByBookid(bookid);
				int i = 1;
				for (OldBookPOJO obp : list) {
			%>
			<div class="img-info">
				<img alt="" src="<%=obp.getIMAGEAPIPATH()%>">
			</div>
			<div class="text-info">
				<h2><%=obp.getTITLE()%></h2>
				<h3>
				...
				<a class="buy-button" style="color:white">Contact To Seller</a>
			</div>
			<div class="other-info">
				...
				<table>
					<tr>
						<td>PUBLISHEDDATE</td>
						<td><%=obp.getPUBLISHEDDATE()%></td>
					</tr>
					<tr>
						<td>CATEGORY</td>
						<td><%=obp.getCATEGORY()%></td>
					</tr>
					<tr>
						<td>ISBN</td>
						<td><%=obp.getISBN()%></td>
				...
				<table>
					<tr>
						<td>BOOKCONDITION</td>
						<td><%=obp.getBOOKCONDITION()%></td>
					</tr>
					<tr>
						<td>TEXTHIGHLIGHT</td>
						<td><%=obp.getTEXTHIGHLIGHT()%></td>
					</tr>
					<tr>
						<td>NOTESINBOOK</td>
						<td><%=obp.getNOTESINBOOK()%></td>
					</tr>
				</table>
		...
		<div class="four-image" style="padding-top: 20px;">
			...
			<%
				...
				List<OldBookPOJO> list1 = dao.getOldBookByCategory(cat);
				// int i=1;
				for (OldBookPOJO obp : list1) {
			%>
			<table>
				<tr>
					<td><img alt="" src="<%=obp.getIMAGEAPIPATH()%>" width="150px"
						height="200px"></td>
				</tr>
				<tr>
