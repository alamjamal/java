...
%>
<%
	ArrayList<CourseTO> ar=new CourseDAOImpl().getEmpRequestList();
%>
	...
	<table width="100%" align="left" border="0" style="vertical-align: top;">
		...
		<tr>
			<td colspan="1"  valign="top">
						...
						<font color="#1B577C" size="4"><b><i>Welcome On Request Coordinator,Here You Can View Emp Request</i></b></font>
					<br/>
...
%>
    	...
    	<td bgcolor="#FFFFFF" width="200"><center>
								<a
									href='<%=basePath%>AddEmpReqAction?req=<%=r2%>&rid=<%=pd.getSheduleid()%>'>Accept</a>&nbsp;&nbsp;
								<a
									href='<%=basePath%>AddEmpReqAction?req=<%=r1%>&rid=<%=pd.getSheduleid()%>'>Reject</a></center></td>
