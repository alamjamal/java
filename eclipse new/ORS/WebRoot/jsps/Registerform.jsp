...
window.location.href='http://'+host+':'+port+'/ORS/ChekUserAction?username='+userName+'&formname=user';
	...
	<table width="100%" align="left" border="0" style="vertical-align: top;">
		...
		<tr>
			<td colspan="1" width="1000"valign="top">
				...
				<font color="#1B577C" size="4"><b><i>Registration form for new faculty</i></b></font>
				 <br/>
				 <br/>
 <form action=<%=request.getContextPath()+"/RegisterAction" %> method="post" name="register"  onSubmit="return validate()">
