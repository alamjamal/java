...
<%
  ...
  java.text.DateFormat dateFormat =
	 java.text.DateFormat.getDateTimeInstance(
       ...
       String deptname=new ProfileDAOImpl().getDeptname((String)session.getAttribute("user"));
%>
	...
	<table width="100%" align="left" border="0" style="vertical-align: top;">
		...
		<tr>
			<td colspan="1" width="700" height="300" valign="top">
				...
				<font color="#1B577C" size="4"><b><i>Welcome H.O.D Of Department <%=deptname %>,To Department Home Page Of </i></b></font>
				<br/><br/>
			...
			<td colspan="1" width="300" height="270" valign="top" align="right">
				<img src=<%=request.getContextPath()+"/images/training.gif" %> height="270" width="300"/>
			</td>
		</tr>
		<tr>
