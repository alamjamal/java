...
<li><a href=<%=request.getContextPath()+"/jsps/sendrequest.jsp" %> target="_self" >REQUEST</a>

</li>
<li><a href=<%=request.getContextPath()+"/jsps/ViewRequest.jsp" %> target="_self" >VIEWREQUEST</a>
